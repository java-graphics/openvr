...
public class Compositor_FrameTiming extends Structure {
    ...
    public int m_nSize; // Set to sizeof( Compositor_FrameTiming )
     ...
     * GPU work can be broken up by calling Flush. This can sometimes be useful to get the GPU started processing that
     * work earlier in the frame.
     */
